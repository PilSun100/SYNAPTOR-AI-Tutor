...
힌트는 일반적인 방향 제시가 아니라 업로드한 강의자료의 관련 chunk를 검색한 뒤, 실제 자료 문장을 단계적으로 가려서 제공합니다.
...
| 단계 | 예시 |
| --- | --- |
| Hint 1 | 자료에서는 이 개념을 핵심 특징 3가지로 설명합니다. |
| Hint 2 | 클러스터가 관리하는 OOOO(OO) 자원 / Pod와 별개의 OO OO를 가짐 |
| Hint 3 | 클러스터가 관리하는 ㅅㅌㄹㅈ(ㅂㄹ) 자원 / Pod와 별개의 ㅅㅁ ㅈㄱ를 가짐 |
